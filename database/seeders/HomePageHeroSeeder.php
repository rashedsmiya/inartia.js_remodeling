...
class HomePageHeroSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        HomePageHero::create([
            ...
            'button1_url' => route('how-it-works'),
            'button2_url' => route('free-estimate'),
            'background_image' => 'default/Get-Your-Free-Estimate.jpg',
            'additional_information' => '<span className="flex items-center justify-center w-5 h-5 rounded-full ring-2 ring-white/60 shrink-0">
